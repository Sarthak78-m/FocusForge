...
export const DUMMY_CONVERSATIONS: Conversation[] = [
  ...
  {
    id: 'conv-2',
    title: 'Productivity schedule planning',
    ...
    messages: [
      {
        id: 'm5',
        role: 'user',
        content: 'Help me plan my work schedule for this week',
