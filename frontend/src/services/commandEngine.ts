...
export const commandEngine = {
  ...
  async processMessage(
    ...
    if (intent.type === 'UNKNOWN') {
      ...
      if (isOffline) {
        return {
          reply: "📶 **You're currently offline.**\n\nI can still help you with your tasks, timer, and study data \u2014 those work offline! For AI-powered coaching and general questions, please reconnect to the internet.\n\nTry: *\"What are my tasks today?\"* or *\"Show my streak\"*",
          action: { type: 'NONE' },
          intent,
        };
      }
