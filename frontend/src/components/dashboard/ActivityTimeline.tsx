...
export function ActivityTimeline() {
  const activity = useNoteStore((s) => s.activity);
    ...
    return (
      <section>
        ...
        <EmptyState
          ...
          description="Your activity will appear here as you create and edit notes."
        />
      </section>
    );
  }
        ...
        <ul className="space-y-0.5">
          {activity.slice(0, 6).map((a) => {
            ...
            return (
              ...
              >
                <div
                  className={`h-7 w-7 rounded-md flex items-center justify-center shrink-0 ${colorMap[a.type]}`}
                >
