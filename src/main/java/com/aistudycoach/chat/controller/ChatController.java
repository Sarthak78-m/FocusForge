package com.aistudycoach.chat.controller;
...
import com.aistudycoach.chat.service.ChatService;
...
@Slf4j
@Tag(name = "Chat", description = "AI Study Coach Chatbot APIs")
@RestController
...
public class ChatController {
    ...
    @Operation(summary = "Send message to AI Study Coach with application context")
    @PostMapping("/message")
