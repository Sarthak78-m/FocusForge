...
import com.mindsprint.exception.EmailDeliveryException;
...
public class EmailService {
    ...
    public void sendVerificationEmail(User user, String rawToken) {
        ...
        String subject = "Verify your FocusForge Account";
        String htmlBody = """
                <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0;">
                    <div style="text-align: center; margin-bottom: 24px;">
                        <h2 style="color: #4f46e5; margin: 0; font-size: 24px; font-weight: 800;">FocusForge</h2>
                        <p style="color: #64748b; font-size: 14px; margin-top: 4px;">Mind Sprint & Productivity Studio</p>
                    </div>
                    <div style="padding: 24px; background-color: #f8fafc; border-radius: 12px; margin-bottom: 24px;">
                        ...
                        <p style="color: #334155; font-size: 14px; line-height: 1.6;">
                            Thank you for joining FocusForge. Please click the button below to verify your email address and activate your study workspace.
                        </p>
    ...
    public void sendPasswordResetEmail(User user, String rawToken) {
        ...
        String subject = "Reset your FocusForge Password";
        String htmlBody = """
                <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0;">
                    <div style="text-align: center; margin-bottom: 24px;">
                        <h2 style="color: #4f46e5; margin: 0; font-size: 24px; font-weight: 800;">FocusForge</h2>
                    ...
                    <div style="padding: 24px; background-color: #f8fafc; border-radius: 12px; margin-bottom: 24px;">
                        ...
                        <p style="color: #334155; font-size: 14px; line-height: 1.6;">
                            We received a request to reset your FocusForge password. Click the button below to choose a new password.
                        </p>
                        <div style="text-align: center; margin: 28px 0;">
                            <a href="%s" style="background: linear-gradient(135deg, #4f46e5 0%%, #7c3aed 100%%); color: #ffffff; padding: 14px 28px; text-decoration: none; font-weight: 700; font-size: 14px; border-radius: 9999px; display: inline-block; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.25);">
                                Reset Password
    ...
    public void sendPasswordChangedNotification(User user) {
        String subject = "Security Alert: FocusForge Password Updated";
        String htmlBody = """
                <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0;">
                    <div style="text-align: center; margin-bottom: 24px;">
                        <h2 style="color: #4f46e5; margin: 0; font-size: 24px; font-weight: 800;">FocusForge</h2>
                    ...
                    <div style="padding: 24px; background-color: #f8fafc; border-radius: 12px; margin-bottom: 24px;">
                        ...
                        <p style="color: #334155; font-size: 14px; line-height: 1.6;">
                            Hi %s, your FocusForge account password was successfully updated.
                        </p>
    ...
    public void sendWelcomeEmail(User user) {
        String subject = "Welcome to FocusForge! 🚀 Your Study Workspace is Ready";
